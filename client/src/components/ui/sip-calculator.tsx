...
export function SipCalculator({ onStart }: SipCalculatorProps) {
  ...
  return (
    <Card className="bg-neutral-50 rounded-xl border border-neutral-100 shadow-sm">
      <CardContent className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-4 bg-white rounded-lg border border-neutral-100 text-center">
            ...
            <div className="p-4 bg-white rounded-lg border border-neutral-100 text-center col-span-2">
