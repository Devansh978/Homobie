  ...
  const SummaryCard = ({ title, value, isPositive = true }) => (
    <div
      className={`p-3 rounded-lg ${
        isPositive ? "bg-green-900" : "bg-red-900"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            {isMobile && (
              <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                <SummaryCard
                  ...
                  value={totalExpenses}
                  isPositive={totalExpenses <= income}
                />
              ...
              <div className="space-y-3">
                <div className="p-3 bg-gray-800 rounded-lg border border-gray-700">
                  ...
                  <p className="text-xl font-semibold text-white">
                    ₹
                    {(typeof income === "number" ? income : 0).toLocaleString()}
                  </p>
                </div>
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            ...
            >
              ...
              <div
                className="h-68 sm:h-80bg-gradient-to-br from-gray-900 to-black rounded-xl border border-white shadow-lg
 p-2"
              >
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-700">
                  <thead className="bg-gray-800">
                    <tr>
                      <th className="px-2 sm:px-4 py-2 text-left text-xs font-medium text-white uppercase tracking-wider">
                        Category
                      </th>
                      <th className="px-2 sm:px-4 py-2 text-left text-xs font-medium text-white uppercase tracking-wider">
                        Amount
                  ...
                  <tbody className="bg-gray-900 divide-y divide-gray-700">
                    {expenses.map((expense) => (
                      ...
                      >
                        ...
                        <td className="px-2 sm:px-4 py-2 whitespace-nowrap">
                          <div className="relative rounded-md shadow-sm">
                            <span className="absolute inset-y-0 left-0 pl-2 flex items-center text-white text-sm">
                              ₹
                            </span>
                            <input
                              type="number"
                        ...
                        <td className="px-2 sm:px-4 py-2 whitespace-nowrap">
                          {(expense.amount || 0) > (expense.max || 0) ? (
                            <span className="px-1 py-0.5 text-xs font-semibold text-red-300 bg-red-900 rounded-full border border-red-700">
                              Over
                            </span>
                          ) : (
                            <span className="px-1 py-0.5 text-xs font-semibold text-green-300 bg-green-900 rounded-full border border-green-700">
                              OK
                            </span>
                          )}
                        </td>
                ...
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="bg-gray-900 divide-y divide-gray-700">
                    <tr>
                      ...
                      <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-white">
                        ₹
                    ...
                    <tr className="bg-green-900 bg-opacity-20">
                      <td className="px-2 sm:px-4 py-2 whitespace-nowrap font-medium text-green-300">
                        Remaining
                      </td>
                      <td className="px-2 sm:px-4 py-2 whitespace-nowrap font-medium text-green-300">
                        ₹{remainingBudget.toLocaleString()}
