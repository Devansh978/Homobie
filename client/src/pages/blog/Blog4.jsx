...
const Blog4 = ({ styles }) => (
  <div className="max-w-4xl mx-auto px-4 py-8 text-white">
    ...
    <p className="mb-4">
      ...
      prepayment fees on{" "}
      <strong className="font-semibold">floating-rate home loans</strong>.
    ...
    <p className="mb-4">
      These ratios help banks minimize risk and borrowers understand their equity vs debt better.
    </p>
