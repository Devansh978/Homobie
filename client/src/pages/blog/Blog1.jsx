...
const Blog1 = ({ styles }) => (
  ...
  <div className="max-w-4xl mx-auto">
    ...
    {/* Calculator Section */}
    <section className="bg-gradient-to-r from-blue-700 to-blue-800 rounded-xl shadow-lg p-6 sm:p-8 mb-8 sm:mb-10 text-white">
      <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
      ...
      <p className="leading-relaxed mb-3 sm:mb-4 text-blue-100 text-sm sm:text-base">
      ...
      <p className="leading-relaxed text-blue-100 text-sm sm:text-base">
    ...
    {/* Summary Checklist */}
    <section className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-lg p-6 sm:p-8 mb-8 sm:mb-10 border border-gray-700">
      <h2 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-100 flex items-center">
        <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 mr-2 sm:mr-3" />
        Fast & Easy Home Loan Eligibility Checklist
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div className="space-y-3 sm:space-y-4">
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
          ...
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
            ...
            <p className="text-gray-300 text-xs sm:text-sm mt-1">21–60 (salaried), up to 65</p>
          </div>
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
            <strong className="text-green-400">Credit Score</strong>
            <p className="text-gray-300 text-xs sm:text-sm mt-1">CIBIL 750+</p>
          </div>
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
            <strong className="text-green-400">Debt Ratio</strong>
            <p className="text-gray-300 text-xs sm:text-sm mt-1">DTI &lt; 40%</p>
          </div>
        </div>
        <div className="space-y-3 sm:space-y-4">
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
          ...
          <div className="bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm">
            ...
            <div className="text-gray-300 text-xs sm:text-sm mt-1 space-y-1">
