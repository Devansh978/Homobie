...
const Blog3 = () => (
  <div className="min-h-screen text-gray-200">
    <div className="max-w-4xl mx-auto">
      ...
      {/* Introduction */}
      <section className="bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-10">
      ...
      <section className="bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-10">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300 text-sm sm:text-base">
          ...
          <li>
            Tax benefits – Consider deductions under{" "}
            <strong className="text-purple-500 font-semibold">Section 24</strong> and{" "}
            <strong className="text-purple-500 font-semibold">Section 80C</strong>.
          </li>
        </ul>
      </section>
      ...
      <section className="bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-10">
        ...
        <p className="text-gray-300 leading-relaxed text-sm sm:text-base mb-3 sm:mb-4">
          If loan interest exceeds average <strong className="text-green-500 font-semibold">SIP returns</strong> (post-tax), prepaying might be wiser.
          Otherwise, SIP may yield better long-term growth.
        </p>
        <blockquote className="border-l-4 border-yellow-500 pl-3 sm:pl-4 italic text-gray-100 mb-3 sm:mb-4 text-sm sm:text-base">
        ...
        <p className="text-gray-300 font-medium text-sm sm:text-base">
          Assess your risk tolerance, financial goals, and market conditions before deciding.
        </p>
      </section>
