...
export default function HomePage() {
  ...
  return (
    <div className="bg-black text-white pt-10 overflow-hidden relative font-sans">
          ...
          >
            ...
            >
              <motion.h1
                ...
                className="text-xl md:text-2xl font-medium mb-3 leading-relaxed p-1 text-center tracking-tight"
              >
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              >
                ...
                >
                  With our platform, reinvest your SIPs strategically to reduce
                  your interest, shorten your tenure, and own your home faster.
                </motion.p>
