  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        'https://homobie.ap-south-1.elasticbeanstalk.com/register/update',
        {
          method: 'PUT',
            ...
            {isBuilder && (
              <div className="space-y-6 pt-6 border-t border-gray-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-100">Builder Information</h3>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-md font-semibold text-gray-100">Company Address</h4>
                </div>
